"""
Pruebas para la Lista Ordenada Estática (por arreglos)
...
Pruebas incluidas:
  ...
  7. Elimine       - casos borde: primer elemento, último elemento, vaciar lista
 ...
 14. Redimensionar - la lista crece cuando se llena el arreglo
"""
...
# =============================================================
# 7. Elimine: casos borde del arreglo
# =============================================================
titulo("Elimine: primer elemento, último elemento, vaciar lista")
lista2 = ListaOrdenadaEstática()
...
print("Tras eliminar primer elemento:", lista2.llaves())

lista2.elimine("gamma")
assert lista2.llaves() == ["beta"]
print("Tras eliminar último elemento:", lista2.llaves())
...
# =============================================================
# 14. Redimensionar: la lista crece cuando se llena
# =============================================================
titulo("Redimensionar: insertar más elementos que el tamaño inicial")
lista8 = ListaOrdenadaEstática(tamaño=3)
lista8.asigne("uno",    "valorunoaaaaaaaaaaaa")
lista8.asigne("dos",    "valordosaaaaaaaaaaaa")
lista8.asigne("tres",   "valortresaaaaaaaaaaa")
lista8.asigne("cuatro", "valorcuatroaaaaaaaaa")  # fuerza redimensionado

assert len(lista8) == 4
assert lista8.obtenga("cuatro") == "valorcuatroaaaaaaaaa"
print("Lista redimensionada correctamente, tamaño:", len(lista8))
print("Llaves tras redimensionar:", lista8.llaves())
